...
const dummyTodos: Todo[] = [
  ...
  },
  {
    ...
    isCompleted: false,
    task: 'Watch movie with friends and some random text that I write now to test things',
    category: 'Recreation',
    dueDate: '2024-05-07',
    priority: 'Normal',
    note: 'Choose a movie and time bumboclaat bumboclaat bumboclaat bumboclaat bumboclaat bumboclaat',
    isCarriedOver: true,
    checklist: [],
  },
  {
